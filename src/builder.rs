...
impl Builder {
    ...
    pub fn build_call(&self, function: &FunctionValue, args: &[&BasicValue], name: &str, fast_call: bool) -> Either<BasicValueEnum, InstructionValue> {
    ...
    pub fn build_select<T: BasicValue>(&self, condition: impl IntMathValue, then: T, or: T, name: &str) -> BasicValueEnum {
        ...
        let value = unsafe {
            LLVMBuildSelect(self.builder, condition.as_value_ref(), then.as_value_ref(), or.as_value_ref(), c_string.as_ptr())
        };
