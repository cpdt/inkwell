...
impl FunctionValue {
    pub(crate) fn new(value: LLVMValueRef) -> Option<Self> {
        ...
        unsafe {
            assert!(!LLVMIsAFunction(value).is_null() || !LLVMIsAInlineAsm(value).is_null())
        }
