...
impl TargetMachine {
    ...
    pub fn get_data(&self) -> TargetData {
        let data = unsafe { LLVMCreateTargetDataLayout(self.target_machine) };
        TargetData::new(data)
    }
